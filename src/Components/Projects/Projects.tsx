...
const Project = () => {
  return (
    <group position={[-5, 0, -4]}>
      ...
      />
      <SmartGarant
        description="J'ai collaboré et supervisé la création d'un site web complet, en contribuant au frontend avec du ReactJS ainsi que tu TypeScript et au backend avec la mise en place du headless CMS Strapi."
